(function ($) {
    ...
    createDropdown: function () {
      ...
      drop =
        '<div class="dropdown bootstrap-select' + showTick + inputGroup + '">' +
          '<button type="button" class="' + this.options.styleBase + ' " ' + (this.options.display === 'static' ? 'data-display="static"' : '') + 'data-toggle="dropdown"' + autofocus + ' role="combobox" aria-owns="' + this.selectId + '" aria-haspopup="listbox" aria-expanded="false">' +
  ...
  function Plugin (option) {
    ...
    if (version.major === '4') {
      ...
      classNames.BUTTONCLASS = ' custom-select custom-select-sm';
