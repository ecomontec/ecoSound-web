...
(
    ...
    `external_recording_url` varchar(255) COLLATE utf8_unicode_ci                                DEFAULT NULL,
...
(
    ...
    `medium`               varchar(50) COLLATE utf8_unicode_ci                              DEFAULT NULL,
    `recording_gain`       int(11)                                                          DEFAULT NULL,
    `duty_cycle_recording` int(11)                                                          DEFAULT NULL,
    `duty_cycle_period`    int(11)                                                          DEFAULT NULL,
...
--
ALTER TABLE `task`
    ADD CONSTRAINT `task_user_id_fk_1` FOREIGN KEY (`assigner_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
    ADD CONSTRAINT `task_user_id_fk_2` FOREIGN KEY (`assignee_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
    ADD CONSTRAINT `task_recording_id_fk` FOREIGN KEY (recording_id) REFERENCES recording (recording_id) ON DELETE CASCADE ON UPDATE CASCADE,
    ADD CONSTRAINT `task_tag_id_fk` FOREIGN KEY (tag_id) REFERENCES tag (tag_id) ON DELETE CASCADE ON UPDATE CASCADE;
--
